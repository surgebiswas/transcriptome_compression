function NCBI_SRA_Mmusculus_plot_PCA( lY, coef, qt, pexp )
    ...
    queries = { {'hematopoetic', 'lymphatic'},  {'stem_cell'}, {'reproductive'}, ...
    ...
    labels = {'hematopoetic/lymphatic', 'stem cell', 'reproductive', 'embryonic', ...
              'connective/epithelium/skin', ...
              'viscera', ...
              'musculoskeletal', 'liver', 'nervous', 'developing nervous', ...
              'annotation pending'};
    
    colors = [ 26, 255, 83; 220 20 60; 250 128 114; 128 0 0; 
    ...
    for j = 1 : 2
        ...
        if j == 1; plotSave('figures/pca/NCBI_SRA_Mmusculus_PCA_legend.png'); close; end
    end
