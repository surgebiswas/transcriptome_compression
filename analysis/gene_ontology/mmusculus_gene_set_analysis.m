...
for i = 1 : numel(ann)
    rowidx = genes2idx(ann(i).DB_Object_Symbol);
...
if false
    ...
    % Min GO Term size: 50	Max GO Term Size: 2000	Num. Genes Covered: 14897	Num. GO Terms: 453
...
save(['Mmusculus_representative_gene_set_', datestr(today), '.mat'], 'sets', 'setnames', 'goids_final');
