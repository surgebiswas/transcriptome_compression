...
%   See also SENDMAIL.
%
% You must modify the first two lines of the code (code inside the dofuble 
% lines) before using.
...
mail = 'surgebiswas@gmail.com';    %Your GMail email address
password = 'bruno#07';          %Your GMail password
% =========================================================================
